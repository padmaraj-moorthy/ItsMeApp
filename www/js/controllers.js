...
.controller('UsersCtrl', function($scope, $window, Users) {
  ...
  Users.getall(function(dataResponse) {
...
.controller('UserDetailCtrl', function($scope, $stateParams, $window, Users) {

  var userId = $stateParams.userId;
  console.log("User ID  :"+ userId);
  Users.getUser(userId, function(dataResponse) {
        $scope.userItem = dataResponse;
    });
  console.log("User Details from MongoLab : "+JSON.stringify($scope.userItem));
})

.controller("ExampleCtrl", function($rootScope, $scope, $http, $cordovaCamera,$cordovaCapture,$cordovaFile,$cordovaNetwork,$ionicModal, $ionicPopup,$ionicLoading,$location, Users, $window) {
